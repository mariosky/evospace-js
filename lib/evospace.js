...
exports.Individual = function(args){
    ...
    this.put = function(population){
        ...
        {  redis.multi()
                ...
                .zadd('z'+population,self.score,self.id)
...
exports.Population = function(name) {
    ...
    this.read_zrange = function (start,stop ,callback){
        ...
        redis.zrange('z'+this.name,start,stop ,function (err, result)
        {
    ...
    this.read_zrevrange = function (start,stop ,callback){
        ...
        redis.zrevrange('z'+this.name,start,stop ,function (err, result)
        {
            console.log("[DEBUG][read_all keys] %s", JSON.stringify(result));
    ...
    this.put_sample = function(sample){
        var self = this;
        console.log("[DEBUG][put_sample sample.sample_id] %s", JSON.stringify(sample.sample_id));
        redis.pipeline()
...
var pop = new exports.Population("pop2");
