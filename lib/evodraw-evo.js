...
exports.evolve_Tournament = function(pop, sample_size, tournament_size,mutation_rate){
    ...
    exports.calcFitness('pop',sample_size,function(err,population){
        ...
        console.log("[DEBUG][pop_fitness] %s", JSON.stringify(pop_fitness));
        ...
        if (pop_fitness.length >= sample_size) {
            ...
            var pool = tournament_selection(pop_fitness, 4,sample_size);
