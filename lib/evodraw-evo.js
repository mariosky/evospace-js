                        ...
                        MHGETALL(keys, function (err, events)
                            {
                                ...
                                fitness(clean, totals);
                                console.log("[DEBUG][db.MHEGETALL] %s: total:%s happy:%s engaged:%s ", individual.id , totals.total, totals.happy, totals.engaged);
...
var fitness = function( frames, totals ){
